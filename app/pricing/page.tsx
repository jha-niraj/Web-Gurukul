				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					...
					>
						...
						<h1 className="text-4xl md:text-6xl font-bold mb-6">
							...
							<br />
							<span className="text-gray-800">School Management System</span>
						</h1>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					...
					>
						...
						<div className="mt-12">
							<Button
								size="lg"
								className="bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-700 hover:to-emerald-700 text-white px-8 py-4 text-lg font-semibold"
							>
